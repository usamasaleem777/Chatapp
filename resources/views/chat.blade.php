        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            <div>
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white focus:outline-none">
                            <div>{{ Auth::user()->name }}</div>
                            <div class="ml-1">
                                <svg class="fill-current h-4 w-4" viewBox="0 0 20 20">
                                    <path d="M5.293 7.293l4.707 4.707 4.707-4.707-1.414-1.414L10 9.586 6.707 5.879z" />
                                </svg>
                            </div>
                        </button>
                    </x-slot>
        ...
        <div class="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 shadow-lg rounded-lg sm:rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-all">
                ...
                <div class="p-3 sm:p-4 bg-gray-50 dark:bg-gray-800">
                    @livewire('chat') {{-- Livewire chat component --}}
                </div>
            </div>
        </div>
    </div>
